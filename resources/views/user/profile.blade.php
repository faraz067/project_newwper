        ...
        <div class="col-md-8">
            <div class="card shadow border-0">
                ...
                <div class="card-body">
                    ...
                    {{-- FORM EDIT PROFIL --}}
                    {{-- FIX: Menggunakan @method('PATCH') agar sesuai dengan Route Profile Breeze --}}
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">*Email tidak dapat diubah di halaman ini.</small>
                        </div>
                        ...
                        <hr class="my-4">
                        <h6 class="text-danger fw-bold mb-3"><i class="fas fa-lock me-1"></i> Ganti Password (Opsional)</h6>
                        ...
                        <div class="d-grid mt-4">
                            <button type="submit" class="btn btn-primary btn-lg font-weight-bold shadow-sm">
                                SIMPAN PERUBAHAN
                            </button>
                        </div>
                    </form>
